...
My interests are in developing more knowledge to reduce violence against children and Adverse Childhood Experiences (ACEs), with the aim of improving child and family well-being. It is my hope that a better understanding of how to reduce violence against children, how to reduce ACEs, and how to increase positive parenting, will contribute to a better understanding of how to improve mental health and well-being across the lifespan. My current research focuses on parenting and child development using international data. I try to understand these issues within the context of current conversations about children’s rights.
...
Our meta-analytic review of 50 years of research on the outcomes of physical punishment [@Gershoff2016] demonstrated that physical punishment is associated with a wide variety of negative outcomes [[*learn more*](https://agrogan1.github.io/CP-meta.html)], and has been part of several national level policy discussions on parenting. In 2018, the American Academy of Pediatrics passed a policy statement discouraging the use of physical punishment of children [@Sege2019]. Our meta-analysis was cited in that policy statement. Referring to our work, the policy statement indicated that "A 2016 meta-analysis showed that current literature does not support the finding of benefit from physical punishment in the long-term." Similarly, in early 2019, the American Psychological Association also passed a resolution discouraging the use of physical punishment [@AmericanPsychologicalAssociation2019]. This policy statement also cited our meta-analysis.
...
Finally, we are beginning to examine the association of more macro-level, or structural, factors with parenting and children's outcomes. Most recently we have been focusing on the association of gender inequality [@Ma2022; @Ward2024] and political violence [@Ma2025] with physical abuse, parental discipline, and child outcomes.

Lastly, a part of my work has often been with projects from Spanish speaking countries, and I've published articles in Spanish, and given Spanish language presentations [@Lucumi2013; @Sanhueza2011; @Grogan-Kaylor2014A; @Grogan-Kaylor2014B].
