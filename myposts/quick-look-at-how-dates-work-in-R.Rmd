...
> *Internally*, R understands dates as the number of days that have elapsed since **January 1, 1970**. Hence, dates are numbers that can be *compared*, *added*, and *subtracted* in a fashion similar to other numbers. However, when numbers are formatted as dates, they are presented as dates in summary statistics and graphs.
