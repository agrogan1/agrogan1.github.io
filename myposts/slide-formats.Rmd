...
Over the past few months, I have been experimenting a lot with different slide show formats. Some slide formats make beautiful slides, but every format seems to have its own limitations.
...
* *CSS*: Another customization consideration. Can CSS be easily used?
...
> My favorite format is Slidy right now, because it allows slides to easily overflow, and because it can easily be modified with [custom CSS](https://agrogan1.github.io/R/YAML-test/slidy.css). My **workflow** right now is to use Slidy for presentation slides, and then render the RMarkdown document as PDF for PDF handouts.
