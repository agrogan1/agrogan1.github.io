...
mypie <- ggplot(mydata,
  ...
  geom_bar() +
  coord_polar(theta = "y") +
  scale_fill_manual(values = c("darkgrey", "red", "black")) + 
  theme_void()
...
myplot1 <- ggplot(data = mydata,
  ...
  scale_fill_manual(values = c("darkgrey", "red", "black")) +
  scale_color_manual(values = c("darkgrey", "red", "black")) +
...
In the graphs below, *group* will again go on the x axis.  *Risk* will go on the y axis.  In drawing this information in various ways--employing various geometries--I am going use colors (black, red and grey) for fill and color. 
...
myplot + 
  ...
  labs(title = "Mean Risk By Group",
       y = "Mean Risk") +
  scale_color_manual(values = c("darkgrey", "red", "darkgrey")) +
  scale_fill_manual(breaks = c("Group A", 
                               "Group B", 
                               "Group C"),
                    values = c("darkgrey", "red", "darkgrey"))
