...
description: |
  Experimenting with a new format for sharing research.
author:
...
For [our work with the UNICEF Multiple Indicator Cluster Survey (MICS) data](https://agrogan1.github.io/#multiple-indicator-cluster-surveys-mics-unicef-data) on parenting and child development in Low and Middle Income Countries around the world, I have been experimenting with the ArcGIS "storymaps" format:
