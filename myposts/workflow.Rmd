...
knitr::include_graphics("workflow/mybargraph.png")

```

```{r, fig.cap="Scatterplot of Penguin Culmen Length by Body Mass"}

knitr::include_graphics("workflow/myscatterplot.png")

```

```{r, fig.cap="Descriptive Statistics"}

knitr::include_graphics("workflow/mydescriptives.png")

```

```{r, fig.cap="Regression Results"}

knitr::include_graphics("workflow/myregression.png")
