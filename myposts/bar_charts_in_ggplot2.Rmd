...
So we change this using `stat = "identity"` to indicate that *y* represents the *actual* height of the bars ...
...
> Alternatively, we could use `geom_col()` whose default *stat* is *identity*.
...
ggplot(mydata, # the data that I am using
       aes(x = x, # 'aesthetic' includes x
           y = y)) + # and y
  geom_col(fill = "blue") # use ACTUAL y for bar height
