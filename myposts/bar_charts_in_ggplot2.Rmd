...
ggplot(mydata, # the data that I am using
  ...
  geom_bar(fill = "royalblue") # using bars to graph
...
More examples can be found [here](http://www-personal.umich.edu/~agrogan/how_to_choose_a_chart/how_to_choose_a_chart_v3.html)
