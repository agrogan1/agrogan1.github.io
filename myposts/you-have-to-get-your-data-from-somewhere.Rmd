...
> Note that--in particular--each RMarkdown document needs to have a line, or lines, of code that import the data file for that individual RMarkdown document.
...
[^tilde]: <mark>Sometimes, especially on a Mac, it is necessary to refer to your directory with a `~`, e.g. `~/downloads/project1.RData` or `~/project1/project1.RData`.</mark>
