---
title: "Corporal Punishment Bans" 
subtitle: "Country Level Bans on Corporal Punishment"
---
...
cpbans$country_iso <- countrycode(cpbans$country, 
                                 'country.name', 
                                 'iso3c')
...
cpbans %>% 
  select(total.number.of.bans,
         country,
         year.of.prohibition,
         country_iso) %>%
  relocate(country_iso) %>%
  gt() %>%
  fmt_flag(columns = country_iso) %>%
  cols_label(country_iso = "",
             total.number.of.bans = "Total Number of Bans",
             country = "Country",
             year.of.prohibition = "Year of Ban")
