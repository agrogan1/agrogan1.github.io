...
The data used in this example are derived from the R package by @FAwR.
...
use "https://github.com/agrogan1/multilevel/raw/master/mlm-R2-gutten/gutten.dta"
...
![A Beautiful? Graph of the Gutten Trees](gutten.png){width=80%}
