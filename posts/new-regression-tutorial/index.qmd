...
* $\text{distance} = 6 \times \text{time}$

* $\text{miles} = 6 \times \text{hours}$
...
$$\text{distance} = \text{starting place} + \text{speed} \times \text{hours} + e_i$$
...
$$\text{miles} = 0 + 4.9 \times \text{hours}$$
...
The last thing that I want to do in this tutorial is to ask the computer to make a best guess about the slope and the y-intercept.  
