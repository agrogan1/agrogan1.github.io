...
1. We ran a regression model using `mixed` (we could have used `regress`). 
2. We transferred the values of the $\beta$ regression coefficients to `margins`. 
3. We used `marginsplot` with a few options to see our results.
