...
Many data sets, but not all, are originally created in the *wide* format--as shown in @fig-wide--where every row of data is an *individual*, and an individual only has a *single row*.  Ideally, every row in *wide* data is uniquely identified by an individual *id* number.  

::: {.callout-tip collapse="true"}
## Key Idea: Data In Long Format
