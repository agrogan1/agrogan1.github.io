...
In some commands, I use `///` so that Stata commands can be on multiple lines.
:::
...
::: {layout-ncol=2}
![Palmer Penguins Illustration from Allison Horst](lter_penguins.png){width=33%}
![Culmen Depth from Allison Horst](culmen_depth.png){width=33%}
:::
...
# Histogram: `histogram x` [^stripplot]
...
[^stripplot]: Histograms are often our default choice to display distributions of a single variable, but I have started to think that [`stripplot`'s](https://agrogan1.github.io/posts/stripplot/index.html)--which require a few more options to configure--are often a better choice for more intuitive displays of distributions. 
