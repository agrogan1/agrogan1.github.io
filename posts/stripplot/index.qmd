...
date: "2026-9-1"
categories: [stats, Stata, teaching, dataviz, exploring data]
...
stripplot myaverage, stack width(.25) msymbol(circle) msize(medium)

graph export "mystripplotA.png", replace

stripplot myaverage, stack width(.5) msymbol(circle) msize(medium)

graph export "mystripplotB.png", replace

stripplot myaverage, stack width(1) msymbol(circle) msize(medium)
