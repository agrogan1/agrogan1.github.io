...
`mermaid` is implemented in [RStudio](https://www.rstudio.com/) via the [DiagrammeR](https://rich-iannone.github.io/DiagrammeR/) package. This logic model was made with RStudio.
