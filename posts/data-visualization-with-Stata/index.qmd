...
I have written a [Stata Michigan graph scheme](https://agrogan1.github.io/posts/Michigan-graph-scheme-Stata/index.html) that can be installed. Asjad Naqvi has written [an excellent and comprehensive set of Stata graph schemes](https://github.com/asjadnaqvi/Stata-schemes).
...
twoway scatter height age_base, title("Tree Height by Age") scheme(s1rcolor) msymbol(o)

graph export myscatterS1R.png, width(2000) replace

```

![Scatterplot Of Tree Height By Age With `s1rcolor` Graph Scheme](myscatterS1R.png){width=50%}
...
graph export mybarS1R.png, width(2000) replace

```

![Bar Graph Of Mean Tree Height By Location With `s1rcolor` Graph Scheme](mybarS1R.png){width=50%}
```{stata}
#| output: false
#| echo: true
