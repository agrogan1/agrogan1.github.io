...
For example, I would not want to write the paper that says that smoking prevents lung cancer, nor would I want to write a paper saying spanking is good for children. (I talk in a little more detail about some of the statistical specifics of this process [here](https://agrogan1.github.io/closeread/be-less-wrong/be-less-wrong.html).)
