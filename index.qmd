...
Working closely with many colleagues, we have shown that physical punishment is associated with a wide variety of negative outcomes (e.g. @Gershoff2016) ([*viz.*](https://agrogan1.github.io/research.html#meta-analysis-of-research-on-corporal-punishment)). Additional quantitative work has demonstrated that this finding remains true even in contexts when physical punishment is used minimally, or when used in ostensibly "normative" ways. In a number of papers, we have investigated these associations [across diverse communities and countries](research.qmd). Lastly, in additional papers, we have worked to demonstrate more "causally robust" associations between physical punishment and undesirable child outcomes using a variety of quantitative methods.
