...
A more recent stream of research pays particular attention to parenting and child development [across low and middle income countries (LMIC's)](https://agrogan1.github.io/research.html#multiple-indicator-cluster-surveys-mics-unicef-data). Further, in this new stream of research, we examine a broader range of parenting behaviors, with a particular emphasis on "positive parenting" strategies (e.g. @Ward2022LCA, @Ward2023. From this research, the only positive discipline behavior that has emerged as associated with better child outcomes is "explain[ing] why (child)’s behaviour was wrong." [@Ward2023]
