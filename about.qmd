...
My core intellectual interest is the way in which [parenting behaviors have an effect on child outcomes](https://agrogan1.github.io/research.html). For example, parenting behaviors like the use of corporal punishment, or parental expressions of emotional warmth, are likely to have an effect on child outcomes like aggression, antisocial behavior, anxiety and depression. I am interested in how these dynamics play out [across contexts, neighborhoods, and cultures](https://agrogan1.github.io/multilevel-thinking/).

In my work I use advanced statistical models, like [multilevel models](https://agrogan1.github.io/multilevel/) and some econometric models, and software like [Stata](https://agrogan1.github.io/stats_stuff.html#stata-materials), [R](https://agrogan1.github.io/stats_stuff.html#r-materials) and [GIS](https://agrogan1.github.io/mapping), to examine things like [growth and change over time](https://agrogan1.github.io/multilevel/), or [community, school or parent effects on children and families](https://agrogan1.github.io/multilevel/). I’m also very interested in [data visualization](https://agrogan1.github.io/stats_stuff.html#data-visualization-1).
